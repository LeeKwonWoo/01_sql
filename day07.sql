...
SELECT to_char(12345,'99999999') as '데이타'
  FROM dual
;
-- 앞에 빈 공간을 0으로 채우기

SELECT to_char(12345,'099999999') as 데이터
  FROM dual
;
...
SELECT to_char(12345,'9,999,999,9') as 데이터
  FROM dual
;

---- 2. to_date() : 날짜 패턴에 맞는 문자 값을
--                  날짜 연산이 가능한 날짜 타입으로 변환
...
-- 10일 후의 날짜 연산
SELECT to_date('2019-5월-28','YYYY-MON-DD') + 10 "today(날짜)"
     , '2019-5월-28' "today(문자)"
  FROM dual
;
/*
